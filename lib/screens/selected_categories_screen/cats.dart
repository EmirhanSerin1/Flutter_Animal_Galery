            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    buildOnePhoto(context, imageUrl[0], "1.jpg"),
                    buildOnePhoto(context, imageUrl[0], "2.jpg"),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    buildOnePhoto(context, imageUrl[0], "3.jpg"),
                    buildOnePhoto(context, imageUrl[0], "4.jpg"),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    buildOnePhoto(context, imageUrl[0], "5.jpg"),
                    buildOnePhoto(context, imageUrl[0], "6.jpg"),
                  ],
                ),
              ],
            ),
