...
class TigersGallery extends StatelessWidget {
  const TigersGallery({Key key}) : super(key: key);
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    buildOnePhoto(context, imageUrl[4], "1.jpg", AnimalPhotoDetail(imageUrl[4]+"1.jpg")),
                    buildOnePhoto(context, imageUrl[4], "2.jpg", AnimalPhotoDetail(imageUrl[4]+"2.jpg")),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    buildOnePhoto(context, imageUrl[4], "3.jpg", AnimalPhotoDetail(imageUrl[4]+"3.jpg")),
                    buildOnePhoto(context, imageUrl[4], "4.jpg", AnimalPhotoDetail(imageUrl[4]+"4.jpg")),
                  ],
                ),
